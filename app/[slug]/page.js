...
export default function PerfilPublico() {
  ...
  const waLink = prestador ? `https://wa.me/55${prestador.whatsapp.replace(/\D/g, '')}?text=Olá ${prestador.nome}, vi seu perfil no Procuro Quem Faça e gostaria de um orçamento.` : '#';
      ...
      {loading ? (
        ...
        <div className="max-w-xl mx-auto pt-28 md:pt-36 pb-12 px-6 animate-in fade-in duration-500">
          <section className="text-center mb-10 relative">
            ...
            <h1 className="text-2xl font-bold text-slate-900 uppercase tracking-tight leading-none mb-3">{prestador.nome}</h1>
