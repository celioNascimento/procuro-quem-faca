    ...
    <main className="min-h-screen bg-white font-sans text-slate-800">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-slate-100 px-6 py-4">
        <div className="max-w-xl mx-auto flex justify-between items-center">
          <BackButton href="/prestadores" className="w-10 h-10 rounded-xl" />
      ...
      <div className="max-w-xl mx-auto pt-24 pb-12 px-6">
        ...
        <section className="text-center mb-10">
          ...
          {/* Nome ajustado para text-2xl e font-bold (estilo Apps) */}
          <h1 className="text-2xl font-bold text-slate-900 uppercase tracking-tight leading-none mb-3">
            {prestador.nome}
          </h1>
        ...
        <div className="space-y-6">
          ...
          {/* 2. SOBRE O PROFISSIONAL (BIO MANTIDA / TAGS OCULTAS) */}
          <section className="bg-slate-50/50 rounded-[2.5rem] p-8 border border-slate-100/50 shadow-inner">
          ...
          {/* 3. BOTÃO SOLICITAR ORÇAMENTO */}
          <div className="pt-2">
            <a 
              href={waLink}
              target="_blank"
              rel="noopener noreferrer"
              className="w-full py-6 bg-blue-600 text-white rounded-[2.5rem] font-bold text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-4 shadow-[0_15px_30px_rgba(37,99,235,0.2)] hover:bg-blue-700 hover:shadow-none transition-all active:scale-[0.98]"
            >
