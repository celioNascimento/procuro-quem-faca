...
export default function Header({ href }) {
  ...
  return (
    // overflow-hidden impede que a logo (h-auto) vaze além do h-20/h-28 do nav,
    // evitando sobreposição visual com elementos sticky logo abaixo do header.
    <nav className="fixed top-0 left-0 right-0 z-[100] bg-white/95 backdrop-blur-md font-sans border-b border-slate-100 overflow-hidden">
      <div className="max-w-5xl mx-auto px-4 h-20 md:h-28 flex items-center justify-between">
        ...
        <div className="flex-1 flex justify-center items-center px-2 py-2 md:py-3">
          <Link
            href="/"
