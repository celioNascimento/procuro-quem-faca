        ...
        <div className="w-32 flex justify-end">
          {user ? (
            ...
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-md hover:border-blue-100 transition-all active:scale-95 disabled:opacity-50"
            >
              {authLoading ? (
              ...
              <span className="text-[10px] font-bold uppercase tracking-widest text-slate-600">Acessar</span>
            </button>
          )}
        </div>
      </div>
