          ...
          {ETAPAS.map((etapa, idx) => {
            ...
            return (
              <div key={etapa.ordem} className="flex gap-4">
                ...
                {/* Conteúdo
                    FIX: removido pointer-events-none do wrapper — impedia clique de zoom
                    em fotos já enviadas. Mantida apenas a opacidade para visual de bloqueio.
                    O pointer-events-none foi movido para o label de upload (só quando !concluida).
                */}
                <div className={`flex-1 pb-6 ${isLast ? 'pb-0' : ''} ${bloqueada ? 'opacity-40' : ''}`}>
                  ...
                  <div className={`relative w-full rounded-2xl overflow-hidden border-2 transition-all group ${
                    ...
                    {concluida ? (
                      ...
                      // FIX: pointer-events-none movido para cá — só bloqueia o upload,
